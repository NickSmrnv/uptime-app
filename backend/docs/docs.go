            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.MonitorStats"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/service.UploadedFile"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/uploads/{category}/{filename}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Storage category, such as avatars or files",
                        "name": "category",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "UUID filename with its extension",
                        "name": "filename",
                        "in": "path",
                        "required": true
                    }
        ...
        "/users/me/avatar": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "JPEG or PNG image up to 5 MB and 16 megapixels",
                        "name": "avatar",
                        "in": "formData",
                        "required": true
                    }
        ...
        "model.MonitorStats": {
            ...
            "properties": {
                ...
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.MonitorBucket"
                    }
                },
                "failurePercent": {
                    "type": "number"
